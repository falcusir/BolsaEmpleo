...
public class PedidosControlador {
    ...
    public ArrayList<Object[]> buscarPedidos(String cedula) { 
        ...
        try {
            ...
            String sql = "call sp_buscarPedidos('"+cedula+"');"; 
            ...
            while (resultado.next()) {
                Object[] obpedidos = new Object[5]; //instancia un arreglo tipo objeto de 6
                for (int i = 0; i < 4; i++) {
                    obpedidos[i+1] = resultado.getObject(i+1);//obtener los valores de cada columna
                }
                obpedidos[0]=cont;
